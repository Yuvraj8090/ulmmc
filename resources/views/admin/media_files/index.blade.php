                ...
                @foreach ($mediaFiles as $file)
                    <div
                        ...
                        <div class="flex-1">
                            ...
                            <h3 class="text-sm font-medium text-gray-900 dark:text-gray-100 mb-1">{{ $file->name }}
                            </h3>
                            <p class="text-xs text-gray-500 dark:text-gray-400">{{ $file->mime_type }} |
                        ...
                        <div class="mt-4 flex justify-between space-x-1">
                            ...
                            <button onclick="copyLink('{{ url(Storage::url($file->file_path)) }}')"
                            ...
                            <form action="{{ route('admin.media-files.destroy', $file->id) }}" method="POST"
                                class="flex-1" onsubmit="return confirm('Are you sure you want to delete this file?');">
                                @csrf
                                @method('DELETE')
                                <button type="submit"

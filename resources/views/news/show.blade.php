  ...
  <x-guest-layout>
                  ...
                  document.querySelectorAll("table").forEach(function(table) {
                      ...
                      if (thead && tbody) {
                          ...
                          Array.from(tbody.querySelectorAll("tr")).forEach((row, index) => {
                              ...
                              const displayNumber = useHindiNumbers ? toHindiNumerals(index + 1) : index +
                                  1;
      ...
      <body class="bg-gray-50 text-gray-800">
          ...
          <div class="flex flex-col md:flex-row min-h-screen relative">
              ...
              <button id="sidebarToggle"
                  class="md:hidden fixed bottom-4 left-4 z-50 bg-blue-600 text-white p-3 rounded-full shadow-lg">
              ...
              <!-- Sidebar -->
              <aside id="sidebar"
                  class="sidebar-container w-full md:w-64 bg-white shadow-lg border-r p-4 md:p-6 transition-all duration-300">
    ...
    $url = url($localePrefix . '/news/' . $itemSlug);
...
@endphp
                              ...
                              <li class="nav-item">
                                  <a href="{{ $url }}"
                                      class="flex items-center px-4 py-2 rounded-lg capitalize transition-all duration-200 {{ $isActive ? 'bg-blue-100 text-blue-700 font-semibold' : 'text-gray-700 hover:bg-blue-50 hover:text-blue-600' }}">
              ...
              <main class="flex-1 p-4 md:p-10">
                                  ...
                                  <li class="flex items-center">
                                      @if (!$isCurrent)
                                          <a href="{{ $breadcrumbUrl }}"
                                              class="capitalize text-gray-600 hover:text-blue-600">
                                              {{ $breadcrumbTitle }}
                                          </a>
                                          <svg class="mx-2 w-4 h-4 text-gray-400" fill="none" stroke="currentColor"
                                              viewBox="0 0 24 24">
                                      ...
                                      @else
                                          <span class="active-link capitalize"
                                              aria-current="page">{{ $breadcrumbTitle }}</span>
                                      @endif
                                  </li>
                              @endforeach
                          @else
                  ...
                  <!-- Main Content -->
                  <section
                      class="prose prose-lg max-w-none bg-white p-4 md:p-8 rounded-xl shadow-md prose-headings:text-gray-800 prose-p:text-gray-700 prose-li:list-disc">
                      {!! $body !!}
                  </section>
              </main>
          </div>

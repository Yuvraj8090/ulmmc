...
<body class="font-sans antialiased bg-gray-50 text-gray-800">
    ...
    <div x-data="{ sidebarOpen: window.innerWidth >= 1024, darkMode: localStorage.getItem('darkMode') === 'true' }" 
         :class="{ 'dark': darkMode }" class="flex h-screen transition-colors duration-300">
        ...
        <aside :class="sidebarOpen ? 'translate-x-0' : '-translate-x-full'"
            ...
            <div class="px-4 py-6">
                <p class="text-xs uppercase text-gray-500 dark:text-gray-400 mb-3 ml-2">Navigation</p>
                <nav class="space-y-1">
                    ...
                    <x-nav-link href="{{ route('admin.navbar-items.index') }}" :active="request()->routeIs('admin.navbar-items.*')">
                        <i class="fas fa-user-tag mr-3"></i>
                        Nav Items
                    </x-nav-link>
                     <x-nav-link href="{{ route('admin.pages.list') }}" :active="request()->routeIs('admin.pages.*')">
                        <i class="fas fa-user-tag mr-3"></i>
                        Pages
                    </x-nav-link>
                </nav>
                ...
                <div class="mt-10">
                    <p class="text-xs uppercase text-gray-500 dark:text-gray-400 mb-3 ml-2">Resources</p>
                    <a href="#" class="group flex items-center px-2 py-2 text-sm font-medium rounded-md text-gray-600 dark:text-gray-300 hover:bg-gray-50 dark:hover:bg-gray-700 transition-colors">
        ...
        <div class="flex-1 flex flex-col overflow-hidden">
            ...
            <header class="bg-white dark:bg-gray-800 shadow-sm z-10 border-b dark:border-gray-700">
                <div class="flex justify-between items-center p-4 sm:px-6">
                    <div class="flex items-center">
                        <button @click="sidebarOpen = true" class="lg:hidden mr-4 text-gray-500 dark:text-gray-400 hover:text-gray-600 dark:hover:text-gray-300">
                    ...
                    <div class="flex items-center space-x-4">
                        ...
                        <div class="hidden md:block relative">
                            <input type="text" placeholder="Search..." class="pl-10 pr-4 py-2 rounded-lg border border-gray-300 dark:border-gray-600 bg-gray-50 dark:bg-gray-700 text-gray-800 dark:text-gray-200 focus:ring-2 focus:ring-indigo-500 focus:border-transparent w-64">
                            <i class="fas fa-search absolute left-3 top-3 text-gray-400"></i>
                        </div>
                        
                        <!-- Notifications -->
                        <div class="relative" x-data="{ open: false }">
                            <button @click="open = !open" class="p-2 rounded-full text-gray-500 dark:text-gray-400 hover:bg-gray-100 dark:hover:bg-gray-700">
                            ...
                            <div x-show="open" @click.away="open = false" 
                                ...
                                <div class="divide-y divide-gray-100 dark:divide-gray-700">
                                    <a href="#" class="flex px-4 py-3 hover:bg-gray-50 dark:hover:bg-gray-700">
                                        <div class="flex-shrink-0 bg-indigo-100 dark:bg-indigo-900 text-indigo-600 dark:text-indigo-400 rounded-full p-2">
                                    ...
                                    <a href="#" class="flex px-4 py-3 hover:bg-gray-50 dark:hover:bg-gray-700">
                                        <div class="flex-shrink-0 bg-green-100 dark:bg-green-900 text-green-600 dark:text-green-400 rounded-full p-2">
                                            <i class="fas fa-server text-xs"></i>
                                        </div>
                                        <div class="ml-3">
                                            <p class="text-sm font-medium text-gray-800 dark:text-gray-200">Server restarted</p>
                                            <p class="text-xs text-gray-500 dark:text-gray-400">45 minutes ago</p>
                                        </div>
                                    </a>
                                </div>
                                <div class="px-4 py-2 border-t dark:border-gray-700">
                                    <a href="#" class="text-xs text-indigo-600 dark:text-indigo-400 hover:underline">View all notifications</a>
                                </div>
                            </div>
                        </div>
